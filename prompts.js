  ...
  updateEmployee: [
    {
      ...
      filter: (async (val) => {
        const response = await db.findEmployeeId(val);
    ...
    },
    {
      ...
      filter: (async (val) => {
        const response = await db.findRoleId(val);
        return response[0].id;
      }),
    },
  ],
  ...
  updateManager: [
    ...
    },
    {
      ...
      filter: (async (val) => {
        ...
        const response = await db.findManagerId(val);
        return response[0].id;
      }),
    },
  ],
  ...
  removeDep: [
    {
      ...
      filter: (async (val) => {
        const response = await db.findDepartmentId(val);
        return response[0].id;
      }),
    },
  ],
